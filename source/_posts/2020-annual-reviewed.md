...
2020 年 12 月 08 日，我在 QQ 空间发布了篇“预总结”，特地立了个 flag 🚩『2020年最后一周或者 2021 年第一周把年度终结写出来』，防止自己“赖账”😂。毕竟 2019 年都写了份总结了，2020 年的不能少吧！从那时候开始，就在磨磨唧唧的准备材料，写篇文章不容易啊 /(ㄒoㄒ)/~~。
...
可以注意到，在这篇年度总结的题目中我特别提到了思考，且这一年博客首页的 Banner 换了几次 Title 也是和**“思考过程”**有关的。可以引申出一点 - 这一年，相对于结果的产出，我更关注的是过程的收获-解决问题的过程。校招时部分面试的背书式回答让我很不爽「自己太菜😒」，逼自己了解把某项技术出现的历史与原因。
...
这一年，我关注了许多 CS 基础相关「深知与 CS 专业的 dalao 的差距还是很大的」的书籍，为了校招面试，更为了以后更好的发展。今年看的书有部分是和 [Jimmy Song](https://jimmysong.io/about/) dalao 相关的，也因这位 dalao 关注上了 Cloud Native。

#### Coding

到了，Coding 相关的，不得不提 GitHub，作为“资深 GitHub 打卡混子”，除了 Gitee 上为了感受下 DevOps 做的 AI 相关的入门级项目的代码，今年写的大部分代码都以放到了 GitHub 个人公有仓或者私有仓上。看看我的 [GitHub 年度报告](https://report.mdnice.com/)：
...
说起实习，这还是我第一次实习「“打工仔”」，不像有些大佬从大一就开始有实习机会了。三个月的实习期都在“混”一个平台的开发，复习巩固 & 学习了挺多的前端、服务端、性能优化相关的技术，这里有 Cloud Native 相关技术的落地，在这里痛快的玩了几下 Kubernetes，在这里要非常感谢我的 mentor 给了我很多机会让我实践我的想法，将相关技术、规范融入到平台的开发中来，不得不提的是-我所在的部分归属于 Netease 的一个 AI Lab，很幸运能够了解到前沿 RL 相关技术的落地实践，具体就不展开港了。
...
再次顺带一提，20 年凑（“白嫖”）了几个厂的小礼物。

{% fancybox %}
![Gift](https://s3.ax1x.com/2021/01/06/sZllB6.jpg)
{% endfancybox %}
...
2020 年的开源技术社区参与程度还是不行，2021 年继续努力。2020 年末有幸给学弟学妹做了次 Linux 相关的分享，特地回顾了下之前学到的东西，太多纰漏（“虽然我在吹水，对不住，哈哈哈，还白嫖了个小米手环~哈哈哈！”）。[Slides](https://slide.shan333.cn/slides/20201112/)
