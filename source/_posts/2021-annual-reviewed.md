...
music:
  ...
  type: song
  id: 254574
headimg: https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/headimg.png
thumbnail: https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/thumbnail.png
...
[![十年之约](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/forever-blog.png)](https://www.foreverblog.cn/about.html)
...
{% gallery %}
![十年之约审核](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/forever-blog-audit-email.png)
{% endgallery %}
...
{% gallery %}
![GitHub](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/2021-github-contribution.jpg)
{% endgallery %}
...
{% gallery %}
![iPads 上的电子书](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/2021-ebooks.png)
{% endgallery %}
...
{% gallery %}
![那些年的 Slides](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/2021-history-slides.png)
{% endgallery %}
...
{% gallery %}
![学校风景](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/school-scenes.png)
{% endgallery %}
...
{% gallery %}
![kubi](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/my-picture.jpg)
{% endgallery %}

### 游戏-Games

{% gallery %}
![真三国无双 7 帝国](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/7-empires.jpg)
{% endgallery %}

回忆了一下，21 年一如既往的锤老游戏多一点，我把电脑给换了，锤 SC2 更爽了，但是 8 月份的时候国服差不多 GG 了，退出江湖选择养老游戏了。

{% gallery %}
![火焰纹章-晓之女神](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/Fire-Emblem.png)
{% endgallery %}

11 & 12 月有部分时间在和位 dalao 打，“真滴菜”：

![Sniper Elite4](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/Sniper%20Elite4.png)
...
{% gallery %}
![我的语雀](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/yuque.png)
{% endgallery %}
...
{% gallery %}
![折磨](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/juan.jpg)
{% endgallery %}
...
{% gallery %}
![21 年的电影](https://guangzhoushan.oss-cn-guangzhou.aliyuncs.com/blog_annual_reviewed/2021/2021-movies.jpg)
{% endgallery %}
